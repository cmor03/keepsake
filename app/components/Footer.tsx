...
export default function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 py-12 px-8 sm:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/how-it-works" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                How It Works
              </Link>
            </li>
            <li>
